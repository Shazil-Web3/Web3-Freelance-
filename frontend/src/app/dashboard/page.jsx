...
const Dashboard = () => {
  ...
  // Force refresh dashboard data when returning from dispute resolution
  useEffect(() => {
    // Check if we're returning from dispute resolution
    const returningFromDispute = sessionStorage.getItem('returningFromDispute');
    if (returningFromDispute === 'true') {
      sessionStorage.removeItem('returningFromDispute');
      fetchDashboard();
    }
  }, []);
          ...
          {userType === 'freelancer' ? (
            ...
            <>
              ...
              <section className="py-8 relative overflow-hidden w-full max-w-full">
                <div className="absolute top-1/2 left-1/4 w-[18rem] h-[18rem] bg-[radial-gradient(circle,_rgba(34,197,94,0.18)_0%,_transparent_70%)] -translate-y-1/2" />
                <div className="absolute top-1/2 right-1/4 w-[16rem] h-[16rem] bg-[radial-gradient(circle,_rgba(249,115,22,0.16)_0%,_transparent_70%)] -translate-y-1/2" />
                <div className="absolute top-1/3 left-1/3 w-[20rem] h-[20rem] bg-[radial-gradient(circle,_rgba(34,197,94,0.18)_0%,_transparent_70%)] -translate-y-1/2" />
                <div className="container mx-auto px-8 lg:px-12">
